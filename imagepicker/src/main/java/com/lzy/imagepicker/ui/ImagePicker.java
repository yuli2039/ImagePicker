...
public class ImagePicker {
    ...
    public void fromCamera(Activity handleAty, int requestCode) {
        Intent intent = new Intent(handleAty, TakePictureActivity.class);
        handleAty.startActivityForResult(intent, requestCode);
    }

    public void fromGallery(Activity handleAty, int requestCode) {
        Intent intent = new Intent(handleAty, ImageGridActivity.class);
        handleAty.startActivityForResult(intent, requestCode);
    }

    public void toPreview(Activity handleAty, int requestCode, ArrayList<ImageItem> imgs, int currentPosition) {
        Intent intentPreview = new Intent(handleAty, ImagePreviewDelActivity.class);
        intentPreview.putExtra(ImagePicker.EXTRA_IMAGE_ITEMS, imgs);
        intentPreview.putExtra(ImagePicker.EXTRA_SELECTED_IMAGE_POSITION, currentPosition);
        handleAty.startActivityForResult(intentPreview, requestCode);
    }
